...
import { ControlMode } from "../../src/utils/source-utils";
import {
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                value: "e2-standard-8",
                description: "8 vCPU, 32 GB RAM - General Purpose",
              },
              {
                value: "e2-standard-16",
                description: "16 vCPU, 64 GB RAM - General Purpose",
              },
            ],
          },
          {
            ...
            children: [
              {
                value: "e2-highmem-2",
                description: "2 vCPU, 16 GB RAM - General Purpose",
              },
              {
                value: "e2-highmem-4",
                description: "4 vCPU, 32 GB RAM - General Purpose",
              },
              {
                value: "e2-highmem-8",
                description: "8 vCPU, 64 GB RAM - General Purpose",
              },
              {
                value: "e2-highmem-16",
                description: "16 vCPU, 128 GB RAM - General Purpose",
              },
            ],
          },
          {
            ...
            children: [
              {
                value: "e2-highcpu-2",
                description: "2 vCPU, 2 GB RAM - General Purpose",
              },
              {
                value: "e2-highcpu-4",
                description: "4 vCPU, 4 GB RAM - General Purpose",
              },
              {
                value: "e2-highcpu-8",
                description: "8 vCPU, 8 GB RAM - General Purpose",
              },
              {
                value: "e2-highcpu-16",
                description: "16 vCPU, 16 GB RAM - General Purpose",
              },
            ],
          },
        ],
